  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        ember: { DEFAULT: "hsl(var(--ember))", glow: "hsl(var(--ember-glow))" },
        gold: { DEFAULT: "hsl(var(--gold))", soft: "hsl(var(--gold-soft))" },
        charcoal: { DEFAULT: "hsl(var(--charcoal))", deep: "hsl(var(--charcoal-deep))" },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "ember-pulse": "ember-pulse 5s ease-in-out infinite",
      },
    },
  },
